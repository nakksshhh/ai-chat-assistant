...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.session) {
        console.log('Sign in successful, redirecting to /chats')
        router.push('/chats')
      } else {
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="max-w-md w-full relative z-10">
        <div className="text-center mb-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
          ...
          <h1 className="text-3xl font-bold mb-2 animate-in fade-in slide-in-from-bottom-2 duration-1000 delay-300">Welcome Back</h1>
          <p className="text-muted-foreground animate-in fade-in slide-in-from-bottom-2 duration-1000 delay-500">Sign in to continue your conversations</p>
        </div>
